...
<body>
    <div class="col_euro_doll">
    <!-- col for euro-dollars -->
        <div class="str_euro_doll">Доллары</div>
            <div class="num">1</div>
            <div class="num">2</div>
            <div class="num">3</div>
            <div class="num">4</div>
    ...
    <div class="col_lei">
    <!-- col for lei -->
        <div class="str_lei">Леи</div>
            <div class="num">18</div>
            <div class="num">36</div>
            <div class="num">53.5</div>
    ...
    <!-- col for grn -->
        <div class="str_grn">Гривна</div>
            ...
            <div class="num">2043</div>
            <div class="num">2298</div>
            <div class="num">2553</div>
    </div>

    <div class="col_rub">
    <!-- col for rub -->
        <div class="str_rub">Рубли</div>
            ...
            <div class="num">1939</div>
            <div class="num">2262</div>
            <div class="num">2585</div>
            <div class="num">2908</div>
            <div class="num">3232</div>
            <div class="num">3878</div>
            <div class="num">4524</div>
            <div class="num">5171</div>
            <div class="num">5817</div>
            <div class="num">6465</div>
    </div>
    <div class="col_transrub">
    <!-- col for Trans rub -->
        <div class="str_transrub">Пр. рубль</div>
